...
# THEME_CLOCK_COLOR=${THEME_CLOCK_COLOR:-"$_omb_prompt_brown"}
...
OMB_THEME_PURITY_STATUS_BAD="${_omb_prompt_bold_brown}>_${_omb_prompt_reset_color}${_omb_prompt_normal} "
OMB_THEME_PURITY_STATUS_OK="${_omb_prompt_bold_green}>_${_omb_prompt_reset_color}${_omb_prompt_normal} "
...
function _omb_theme_PROMPT_COMMAND {
  ...
  PS1="\n[$(clock_prompt)${_omb_prompt_reset_color}] ${_omb_prompt_bold_gray}\u${_omb_prompt_reset_color} ${_omb_prompt_navy}\w $(scm_prompt_info)\n${ret_status} "
}
